      ...
      {(products.category === 'espresso-machine' ||
        ...
        <div>
          ...
          <p style={{ textAlign: 'justify', textIndent: '3em' }}>
            {products.description?.introText?.[0].content}
          </p>
          <img
            src={products.lifestyleImages?.[0]}
            alt=""
            style={{ width: '1905px', margin: '130px 0 130px -110px' }}
          />
          ...
          {products.lifestyleImages?.length === 4 && (
            <div>
              ...
              {EssentialFeatures()}
              <img
                src={products.lifestyleImages?.[3]}
                alt=""
                style={{ marginLeft: '-110px', width: '1905px' }}
              />
            </div>
          )}
          {products.lifestyleImages?.length === 5 &&
            (products.category === 'grinder-machine' ? (
              <div>
                ...
                {EssentialFeatures()}
                <img
                  src={products.lifestyleImages?.[4]}
                  alt=""
                  style={{ marginLeft: '-110px', width: '1905px' }}
                />
              </div>
          ...
          {products.lifestyleImages?.length === 6 && (
            <div>
              ...
              {EssentialFeatures()}
              <img
                src={products.lifestyleImages?.[5]}
                alt=""
                style={{ marginLeft: '-110px', width: '1905px' }}
              />
            </div>
          ...
          {products.lifestyleImages?.length === 7 && (
            <div>
              ...
              {EssentialFeatures()}
              <img
                src={products.lifestyleImages?.[6]}
                alt=""
                style={{ marginLeft: '-110px', width: '1905px' }}
              />
            </div>
