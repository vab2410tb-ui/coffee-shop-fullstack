...
const ProductAccordion = ({ products, productDetail }) => {
  ...
  const toggleTab = (tabName) => {
    setActiveTabs((prevTabs) =>
      prevTabs.includes(tabName) ? prevTabs.filter((t) => t !== tabName) : [...prevTabs, tabName],
    );
  };
  return (
    <div>
        ...
        <div className={productDetail.techspecs}>
          <div className={productDetail.techspecs}>
            <div className={productDetail.titleTech} onClick={() => toggleTab('techspecs')}>
              <h3 style={{ marginLeft: '45px', fontSize: '24px' }}>Technical Specifications</h3>
              <span>
                <FontAwesomeIcon
                  icon={faAngleDown}
                  style={{
                    marginRight: '25px',
                    fontSize: '30px',
                    transform: activeTabs === 'techspecs' ? 'rotate(180deg)' : 'rotate(0deg)',
            ...
            {products.category === 'espresso-machine' && (
              <div
                className={`${productDetail.accordion_content} ${activeTabs.includes('techspecs') ? productDetail.show : ''}`}
              >
                ...
                <div className={productDetail.accordion_inner}>
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <th>
                          <label>Grinding Speed (rpm):</label>
                        </th>
                        <td>{products.techSpecs?.grindingSpeed}</td>
                      </tr>
                      <tr>
                        <th>
                          <label>Programmable Dose:</label>
                        </th>
                        <td>{products.techSpecs?.programmableDose ? 'Yes' : 'No'}</td>
                      </tr>
                      <tr>
                        <th>
                          <label>Electrical Specifications (Single Phase):</label>
                        </th>
                        <td>{products.techSpecs?.voltage}</td>
                      </tr>
                      <tr>
            ...
            <div
              className={productDetail.titleTech}
              ...
              <span>
                <FontAwesomeIcon
                  ...
                  style={{
                    marginRight: '25px',
                    fontSize: '30px',
                    transform: activeTabs === 'usage' ? 'rotate(180deg)' : 'rotate(0deg)',
                    transition: 'transform 0.3s ease',
                  }}
                />
              </span>
            ...
            <div
              className={`${productDetail.accordion_content} ${activeTabs.includes('usage') ? productDetail.show : ''}`}
            >
              <div className={productDetail.accordion_inner}>
                <div
                  style={{
                ...
                >
                  <ul style={{ marginInline: '50px' }}>
                    <li style={{ marginTop: '30px', fontSize: '20px' }}>
                      Download the product's user and installation manual file here - Download.
                    </li>
                    <li style={{ marginTop: '10px', marginBottom: '40px', fontSize: '20px' }}>
                      If you still have questions about the product, please visit Help Desk for more
                      details.
                    </li>
                  </ul>
                </div>
            ...
            <div
              ...
              style={{ backgroundColor: '#f2f2f2', marginBottom: '-10px', marginTop: '20px' }}
            >
              <h3>Pick-up Time</h3>
              <span>
                <FontAwesomeIcon
                  ...
                  style={{
                    marginRight: '25px',
                    fontSize: '30px',
                    transform: activeTabs === 'pickup' ? 'rotate(180deg)' : 'rotate(0deg)',
                    transition: 'transform 0.3s ease',
                  }}
                />
              </span>
            ...
            <div
              className={`${productDetail.accordion_content} ${activeTabs.includes('pickup') ? productDetail.show : ''}`}
            >
              <div className={productDetail.accordion_inner}>
                <div
                  style={{
              ...
              <span>
                <FontAwesomeIcon
                  ...
                  style={{
                    marginRight: '25px',
                    fontSize: '30px',
                    transform: activeTabs === 'policy' ? 'rotate(180deg)' : 'rotate(0deg)',
                    transition: 'transform 0.3s ease',
                  }}
                />
              </span>
            ...
            <div
              className={`${productDetail.accordion_content} ${activeTabs.includes('policy') ? productDetail.show : ''}`}
            >
              <div className={productDetail.accordion_inner}>
                <div
                  style={{
                ...
                >
                  <ul style={{ marginInline: '50px' }}>
                    <li style={{ marginTop: '30px', fontSize: '20px' }}>
                      Allow customers to exchange/return within 3 days of receipt if they are not
                      satisfied or the product is not as expected.
                    </li>
                    <li style={{ marginTop: '10px', fontSize: '20px' }}>
                      Depending on the applicable conditions, guests can refund or exchange to
                      another product at no cost.
                    </li>
                    <li style={{ marginTop: '10px', marginBottom: '40px', fontSize: '20px' }}>
