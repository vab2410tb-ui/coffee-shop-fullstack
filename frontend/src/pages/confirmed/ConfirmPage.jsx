  ...
  return (
    <div className={confirm.container}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
        ...
        <h1
          style={{ fontSize: '16px', borderBottom: '1px solid #3333331f', paddingBottom: '10px' }}
        >
        ...
        <div className={confirm.form}>
          <div style={{ borderRight: '2px solid #3333331f', paddingRight: '30px', flex: '55%' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span>
                Need help?{' '}
                <NavLink to="/contact" style={{ color: '#60b3f7' }}>
                  Contact us
                </NavLink>
              </span>
          ...
          <div className={confirm.orderDetail}>
            ...
            <div
              style={{ display: 'flex', justifyContent: 'space-between', margin: '20px 0 10px 0' }}
            >
              <span>Subtotal</span>
              <span>
                {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(
